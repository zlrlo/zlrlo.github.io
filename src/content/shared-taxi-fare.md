...
**B** : A → B **VS** A → D → B <br /> = 50 **VS** 20 + 10 = 30

**C** : A → C **VS** A → D → C <br /> = NOT **VS** 20 + 25 = 45

**D** : A → D **VS** A → D → D <br /> = 20 **VS** 20 + 0 = 20
...
**B** : A → B **VS** A → B → B <br /> = 30 **VS** 30 + 0 = 30

**C** : A → C **VS** A → B → C <br /> = 45 **VS** 30 + 5 = 35

**D** : A → D **VS** A → B → D <br /> = 20 **VS** 30 + NOT = 20
...
**B** : A → B **VS** A → C → B <br />= 30 **VS** 35 + NOT = 30

**C** : A → C **VS** A → C → C <br /> = 35 **VS** 35 + 0 = 35

**D** : A → D **VS** A → C → D <br />= 20 **VS** 35 + NOT = 20
